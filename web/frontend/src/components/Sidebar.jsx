...
const Sidebar = ({ currentMode, setMode, onOpenGallery, isGalleryOpen }) => {
        ...
        <div className="h-full w-20 md:w-24 dark:bg-dark-900/80 bg-white/80 backdrop-blur-xl dark:border-r border-r border-white/5 border-gray-200 flex flex-col items-center py-8 z-50 transition-all duration-300">
            ...
            <nav className="flex-1 flex flex-col items-center gap-6 w-full">
                {navItems.map((item) => {
                    ...
                    return (
                        ...
                        >
                            <Icon
                                size={24}
                                className={`transition-all duration-300 ${isActive ? item.color : ''} group-hover:scale-110`}
                ...
                <button
                    ...
                    title="Galeri"
                >
                    <ImageIcon size={24} className={`transition-all duration-300 ${isGalleryOpen ? 'text-accent' : ''} group-hover:scale-110`} strokeWidth={isGalleryOpen ? 2.5 : 2} />
